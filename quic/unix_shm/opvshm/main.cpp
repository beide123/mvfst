...
#include <quic/unix_shm/opvshm/MdlwClient.h>
#include <quic/unix_shm/opvshm/MdlwServer.h>
#include <quic/unix_shm/opvshm/MdlwTransportServer.h>
...
int main(int argc, char* argv[]) {
  ...
  if (FLAGS_mode == "server") {
    ...
    ShmMdlwTransportServer server(FLAGS_host, FLAGS_port);
    server.start();
